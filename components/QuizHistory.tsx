            ...
            {deleteStep === "confirm" && (
              <div className="text-center">
                ...
                <p className="text-sm text-slate-500 mb-6 px-2">
                  This will permanently erase your past scores and reset your
                  dashboard stats to zero. **This action cannot be undone.**
                </p>
            ...
            {deleteStep === "password" && (
              <>
                ...
                <p className="text-sm text-slate-600 text-center mb-6">
                  Please enter your password to confirm you want to reset your
                  statistics.
                </p>
