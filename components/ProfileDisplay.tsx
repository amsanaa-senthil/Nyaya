...
export default function ProfileDisplay() {
  ...
  const { userProfile, loading, handleLogout, router } = useProfileDisplayLogic();
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 space-y-4">
        ...
        <p className="text-gray-500 font-medium animate-pulse">Loading Nyaya Profile...</p>
      </div>
    );
  }
        ...
        <div className="md:col-span-7 p-8 md:p-12 flex flex-col justify-center bg-white">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-4xl font-extrabold text-slate-900 leading-tight">
              {userProfile?.first_name} <span className="">{userProfile?.surname}</span>
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 mb-12">
            ...
            <div className="flex items-center gap-5 group">
              ...
              <div>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-widest mb-0.5">Username</p>
                <p className="text-xl font-semibold text-slate-700">{userProfile?.username || "user_nyaya"}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5 group">
              ...
              <div>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-widest mb-0.5">Email Address</p>
                <p className="text-xl font-semibold text-slate-700">{userProfile?.email || "No email linked"}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5 group">
              ...
              <div>
                <p className="text-[10px] uppercase font-bold text-gray-400 tracking-widest mb-0.5">Member Since</p>
