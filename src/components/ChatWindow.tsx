...
export default function ChatWindow({ messages, isTyping, onSendMessage }: ChatWindowProps) {
    ...
    return (
        <div className="flex-1 relative flex flex-col h-screen bg-grey-50 overflow-hidden font-sans">
            ...
            {/* Navbar */}
            <div className="w-full absolute top-0 left-0 right-0 z-20 flex items-center justify-between p-4 md:p-6 bg-gradient-to-b from-grey-50/80 to-transparent backdrop-blur-[2px]">
